...
__signal__::__signal__() : QObject() {}
__slots__::__slots__() : QObject() {}
...
__global__ &G(){return GLOBAL;}

FRAMELESS_END_NAMESPACE


const QString &Frameless::Theme::Light = "Light";
const QString &Frameless::Theme::Dark = "Dark";
const QString &Frameless::Theme::White = "White";
const QString &Frameless::Theme::Gray = "Gray";
